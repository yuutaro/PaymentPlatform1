          ...
          <div className="drawer">
            ...
            <div className="drawer-side mt-16">
              ...
              <ul className="menu bg-base-200 text-base-content min-h-full w-80 p-4 z-10">
                ...
                <li><a className="text-zinc-800 text-[20px] mt-4">作品を出品</a></li>
                <li><a className="ml-4">絵画 Painting</a></li>
                <li><a className="ml-4">彫刻 Sculpture</a></li>
                <li><a className="ml-4">版画 Printmaking</a></li>
                <li><a className="ml-4">写真 Photography</a></li>

                <li><a className="text-zinc-800 text-[20px] mt-4">作品を探す</a></li>
                <li><a className="ml-4">絵画 Painting</a></li>
                <li><a className="ml-4">彫刻 Sculpture</a></li>
                <li><a className="ml-4">版画 Printmaking</a></li>
                <li><a className="ml-4">写真 Photography</a></li>

                <li><a className="text-zinc-800 text-[20px] mt-4">アーティストを探す</a></li>
                <li><a className="ml-4">絵画 Painting</a></li>
                <li><a className="ml-4">彫刻 Sculpture</a></li>
                <li><a className="ml-4">版画 Printmaking</a></li>
                <li><a className="ml-4">写真 Photography</a></li>
